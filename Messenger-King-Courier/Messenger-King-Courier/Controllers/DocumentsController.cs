...
namespace Messenger_King_Courier.Controllers
{
    public class DocumentsController : Controller
    {
        ...
        {
            var documents = db.Documents.Include(d => d.Client).Include(d => d.Driver);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Documents_ID,Document_ID,Document_Residence,Document_Statement,Client_ID,Driver_IDNo")] Document document)
        {
            if (ModelState.IsValid)
            {
